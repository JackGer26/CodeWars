...
// PREP
// Params: Any lower case letter from the english alphabet
// Returns: Position of letter in the alphabet
// Example: "a" ->  "Position of alphabet: 1"
// Pseudo:
  // switch statement with letter string as condition
  // create case for each letter
  // each case should return "Position of alphabet: number"
